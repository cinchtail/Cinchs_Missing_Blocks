    ...
    public static final ItemGroup CINCHS_MISSING_BLOCKS = Registry.register(net.minecraft.registry.Registries.ITEM_GROUP,
            ...
            FabricItemGroup.builder().displayName(Text.translatable("itemgroup.cinchsmissingblocks"))
                    .icon(() -> new ItemStack(ModBlocks.CALCITE_BRICKS)).entries((displayContext, entries) -> {
                        ...
                        entries.add(ModBlocks.SOUL_SANDSTONE_STAIRS);
                        entries.add(ModBlocks.SOUL_SANDSTONE_SLAB);
                        entries.add(ModBlocks.SOUL_SANDSTONE_WALL);
                        entries.add(ModBlocks.CHISELED_SOUL_SANDSTONE);
                        ...
                        entries.add(ModBlocks.CUT_SOUL_SANDSTONE);
                        entries.add(ModBlocks.CUT_SOUL_SANDSTONE_STAIRS);
                        entries.add(ModBlocks.CUT_SOUL_SANDSTONE_SLAB);
                        entries.add(ModBlocks.CUT_SOUL_SANDSTONE_WALL);
                        entries.add(ModBlocks.SOUL_SANDSTONE_BRICKS);
                        entries.add(ModBlocks.SOUL_SANDSTONE_BRICK_STAIRS);
                        entries.add(ModBlocks.SOUL_SANDSTONE_BRICK_SLAB);
                        entries.add(ModBlocks.SOUL_SANDSTONE_BRICK_WALL);
                        entries.add(ModBlocks.CRACKED_SOUL_SANDSTONE_BRICKS);
                        ...
                        entries.add(ModBlocks.CRACKED_RED_NETHER_BRICK_FENCE_GATE);
                        ...
                        entries.add(ModBlocks.BLUE_NETHER_BRICK_FENCE_GATE);
                        ...
                        entries.add(ModBlocks.CRACKED_BLUE_NETHER_BRICK_FENCE_GATE);
