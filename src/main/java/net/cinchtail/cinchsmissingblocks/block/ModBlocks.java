...
public class ModBlocks {
    ...
    public static final Block CRACKED_NETHER_BRICK_FENCE_GATE = registerBlock("cracked_nether_brick_fence_gate",
            properties -> new FenceGateBlock(ModWoodTypes.NETHER_BRICKS, Block.Settings.copy(Blocks.NETHER_BRICKS)
                    .solid().strength(2.0F, 6.0F)
                    .registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(MOD_ID, "cracked_nether_brick_fence_gate")))));
    ...
    public static final Block RED_NETHER_BRICK_FENCE_GATE = registerBlock("red_nether_brick_fence_gate",
            properties -> new FenceGateBlock(ModWoodTypes.NETHER_BRICKS, Block.Settings.copy(Blocks.NETHER_BRICKS)
                    .solid().strength(2.0F, 6.0F)
                    .registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(MOD_ID, "red_nether_brick_fence_gate")))));
    ...
    public static final Block CRACKED_RED_NETHER_BRICK_FENCE_GATE = registerBlock("cracked_red_nether_brick_fence_gate",
            properties -> new FenceGateBlock(ModWoodTypes.NETHER_BRICKS, Block.Settings.copy(Blocks.NETHER_BRICKS)
                    .solid().strength(2.0F, 6.0F)
                    .registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(MOD_ID, "cracked_red_nether_brick_fence_gate")))));
    ...
    public static final Block BLUE_NETHER_BRICK_FENCE_GATE = registerBlock("blue_nether_brick_fence_gate",
            properties -> new FenceGateBlock(ModWoodTypes.NETHER_BRICKS, Block.Settings.copy(Blocks.NETHER_BRICKS)
                    .solid().strength(2.0F, 6.0F)
                    .registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(MOD_ID, "blue_nether_brick_fence_gate")))));
    ...
    public static final Block CRACKED_BLUE_NETHER_BRICK_FENCE_GATE = registerBlock("cracked_blue_nether_brick_fence_gate",
            properties -> new FenceGateBlock(ModWoodTypes.NETHER_BRICKS, Block.Settings.copy(Blocks.NETHER_BRICKS)
                    .solid().strength(2.0F, 6.0F)
                    .registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(MOD_ID, "cracked_blue_nether_brick_fence_gate")))));
