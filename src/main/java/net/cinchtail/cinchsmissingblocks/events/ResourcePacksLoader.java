...
public class ResourcePacksLoader {
    ...
    public static class ForgeEvents {
        ...
        public static void onAddPackFinders(AddPackFindersEvent event) {
            ...
            registerBuiltInPack(event, modFile,
                    "cinchs_double_slabs",
        ...
        private static void registerBuiltInPack(AddPackFindersEvent event, ModFile modFile,
                                                String folderName, String displayName) {

            Path packPath = modFile.findResource("resourcepacks/" + folderName);
