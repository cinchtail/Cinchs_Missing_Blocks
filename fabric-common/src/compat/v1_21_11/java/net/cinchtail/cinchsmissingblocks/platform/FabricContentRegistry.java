...
public final class FabricContentRegistry {
    ...
    private static void register(BlockSpec spec) {
        ...
        Registry.register(BuiltInRegistries.ITEM, id, new BlockItem(
                block, new Item.Properties().setId(ResourceKey.create(Registries.ITEM, id))
        ));
    ...
    private static void registerItem(ItemSpec spec) {
        Identifier id = FabricResourceIds.toMinecraft(spec.id());
        Item item = Registry.register(BuiltInRegistries.ITEM, id, new Item(
    ...
    public static Block resolveBlock(ResourceId id) {
        ...
        return BuiltInRegistries.BLOCK.getValue(FabricResourceIds.toMinecraft(id));
    }

    public static Item resolveItem(ResourceId id) {
        Item own = ITEMS.get(id);
        if (own != null) return own;
        return BuiltInRegistries.ITEM.getValue(FabricResourceIds.toMinecraft(id));
    }
    ...
    private static BlockBehaviour.Properties applyProperties(BlockBehaviour.Properties properties, BlockPropertiesSpec spec) {
        ...
        properties.sound(switch (spec.sound()) {
            ...
            case CINNABAR, SULFUR -> SoundType.STONE;
        ...
        if (spec.noCollision()) properties.noCollision();
