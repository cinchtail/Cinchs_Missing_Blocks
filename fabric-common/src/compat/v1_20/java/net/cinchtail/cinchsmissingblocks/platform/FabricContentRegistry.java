...
public final class FabricContentRegistry {
    ...
    private static Block createStandardBlock(BlockSpec spec, BlockBehaviour.Properties properties) {
        return switch (spec.kind()) {
            ...
            case PRESSURE_PLATE -> new LegacyPressurePlateBlock(properties);
            case BUTTON -> new LegacyButtonBlock(properties, spec.buttonPressTicks());
        };
    }
    ...
    private static final class LegacyPressurePlateBlock extends PressurePlateBlock {
        private LegacyPressurePlateBlock(BlockBehaviour.Properties properties) {
            super(PressurePlateBlock.Sensitivity.EVERYTHING, properties, BlockSetType.STONE);
        }
    }

    private static final class LegacyButtonBlock extends ButtonBlock {
        private LegacyButtonBlock(BlockBehaviour.Properties properties, int ticks) {
            super(properties, BlockSetType.STONE, ticks, false);
        }
    }
