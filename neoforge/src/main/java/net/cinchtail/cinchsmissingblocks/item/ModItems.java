...
public class ModItems {
    public static final DeferredRegister.Items ITEMS = DeferredRegister.createItems(CinchsMissingBlocks.MOD_ID);
    ...
    public static void register(IEventBus eventBus) {
        ...
        CinchsMissingBlocks.LOGGER.info("Registering ModItems for NeoForge" + MOD_ID);
    }
}